      ...
      <div className=" min-h-screen mt-24  flex flex-col items-center py-10 px-4">
        ...
        <div className="w-full max-w-3xl  p-6 shadow-lg rounded-lg">
          <p className="text-gray-700 mb-4 text-sm md:text-base">
            Please fill out the details of your requirement below and we will
            revert with our quotation within 48 hours. Kindly provide accurate
            manufacturer part number (MPN) or reference link/image to facilitate
            a quick response. Alternatively, you can also share your queries
          ...
          <form className="space-y-4">
            ...
            <p className="text-gray-600 text-sm md:text-base">
              For more products, please upload a file (CSV or XLS)
            </p>
