...
const page = () => {
  ...
  <div className=" min-h-screen mt-24  flex flex-col items-center py-10 px-4">
      <h1 className="text-4xl font-bold text-blue-600 mb-6">RFQ</h1>
      <div className="max-w-3xl  p-6 shadow-lg rounded-lg">
        ...
        <div className="flex justify-between text-gray-700 border-b pb-2 mb-4">
        ...
        <form className="space-y-4">
          ...
          <p className="text-gray-600">For more products, please upload a file (CSV or XLS)</p>
