...
export default function ContactUs() {
  ...
  return (
    ...
    <div className="p-6 border rounded-lg shadow-md max-w-lg mx-auto space-y-4">
      ...
      <p className="text-sm font-medium">WhatsApp: <a href="tel:+918655821346" className="text-blue-600">+91 86558 21346</a></p>
      <p className="text-sm font-medium">Email: <a href="mailto:sales@evelta.com" className="text-blue-600">sales@evelta.com</a></p>
      <p className="text-sm text-gray-600">If you want to know the status of an online order, please visit our <a href="/tracking" className="text-blue-600">tracking page</a>.</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium">What can we help with? *</label>
          <select name="issueType" value={formData.issueType} onChange={handleChange} required className="w-full p-2 border rounded">
