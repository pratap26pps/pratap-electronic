...
export function CarouselSize4() {
  ...
  return (
    <Carousel opts={{ align: "start" }} className="scale-90">
      <CarouselContent>
                 ...
                 <Card className=" flex flex-col justify-between">  
                   ...
                   <Link href={`/checkproduct/${item._id}`}>
                     <div className="shadow shadow-neutral-300 border border-b-gray-200 flex flex-col h-full">
                       ...
                       <div className="h-48 w-48 mx-auto mt-2 flex items-center justify-center overflow-hidden">
